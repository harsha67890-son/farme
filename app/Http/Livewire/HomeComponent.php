...
class HomeComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.home-component',[ 'sliders'=>$sliders, 'products'=>$products,'categorys'=>$categorys,'top_products'=>$top_products,'select_products'=>$select_products,'best_products'=>$best_products])->layout('layouts.base');
    }
}
