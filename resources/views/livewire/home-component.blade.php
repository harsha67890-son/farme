                    ...
                    @foreach ($categorys as $item)
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn">
                                <a href="{{ route('user.category',['category_slug' => $item->slug]) }}" class="circle-1">
    ...
    <div class="container-fluid-lg">
        <div class="title title-flex-2">
            ...
            <ul class="nav nav-tabs tab-style-color-2 tab-style-color" id="myTab">
                <li class="nav-item">
                    <button class="nav-link btn active" id="{{ $item->category_name }}" data-bs-toggle="tab" data-bs-target="#all"
                        type="button">All</button>
                </li>

                @foreach ($categorys as $item)
                    <li class="nav-item">
                        <button class="nav-link btn" id="cooking-tab" data-bs-toggle="tab" data-bs-target="#cooking-{{ $item->slug }}"
        ...
        <div class="tab-content" id="myTabContent">
            ...
            </div><div class="tab-pane fade" id="cooking" role="tabpanel" aria-labelledby="cooking-tab">
                <div class="row g-8">
                    <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                        <div class="product-box-4">
                            <div class="product-image">
                    ...
                    <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                        <div class="product-box-4">
                            <div class="product-image">
                                ...
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/assets/images/veg-3/cate1/14.png') }}" class="img-fluid"
                                        alt="">
                                </a>
        ...
        <div class="row">
            <div class="col-12">
                <div class="newsletter-box hover-effect">
                    <img src="{{ asset('/assets/images/veg-3/shape/background.png') }}" class="img-fluid bg-img"
                        alt="">
