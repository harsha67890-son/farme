        ...
        <div class="row">
            <div class="col-12">
                ...
                <div
                    ...
                    <div>
                        <div class="product-box-3 h-100 wow fadeInUp" style="box-shadow: rgba(0, 0, 0, 0.05) 0px 0px 0px 1px;">
                            ...
                            <div class="product-footer">
                                <div class="product-detail">
                                    ...
                                    <h6 class="unit">{{ $item->packsize->packsize }}</h6>
                                    <h5 class="price"><span class="theme-color">₹ {{ $item->mrp }}</span> <del>₹ {{ $item->price }}</del>
                                    </h5>
