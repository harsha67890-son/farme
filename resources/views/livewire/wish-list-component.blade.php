                    ...
                    <div class="product-box-3 h-100">
                        ...
                        <div class="product-footer">
                            <div class="product-detail">
                                {{-- <span class="span-name">{{ $item->model->category->category_id }}</span> --}}
                                <a href="product-left-thumbnail.html">
                                    <h5 class="name">{{ $item->model->name }}</h5>
                                </a>
                                <h6 class="unit mt-1">{{ $item->model->packsize->packsize }}</h6>
                                <h5 class="price">
                                    <span class="theme-color">{{ $item->model->price }}</span>
                                    <del>$15.15</del>
                                </h5>
