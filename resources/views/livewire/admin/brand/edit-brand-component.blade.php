                    ...
                    <div class="col-sm-8 m-auto">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="{{ route('admin.brand') }}"
                                                ...
                                                <i data-feather="plus-square"></i>List Brand
                                            </a>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <form class="theme-form theme-form-2 mega-form" wire:submit.prevent="updateBrand">
                                    <div class="mb-4 row align-items-center">
                                        <label class="form-label-title col-sm-3 mb-0">Category Name</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" placeholder="Brand Name" wire:model ="brand_name"  wire:keyup="generateslug">
                                        </div>
                                    </div>
                                    <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                           ...
                                           @else
                                               <img src="{{ asset('/images/brand') }}/{{ $image }}" width="120"
                                                   alt="">
                                           @endif
                                        </div>
                                    </div>
